...
import { fadeIn, slideFromLeft, slideFromRight, fadeInScale, staggerFadeIn } from "../lib/animations";
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <SimpleParallax speed={0.2} direction="down" scale={true} className="mb-8">
            ...
            <SimpleParallax speed={0.15} direction="diagonal-down-right" opacityEffect={true}>
            ...
            <SimpleParallax speed={0.05} direction="up" scale={true}>
              <div className="flex justify-center" style={getParallaxStyle(0.08)}>
                <a 
              ...
              <div className="relative w-full aspect-square">
                ...
                >
                  <div className="w-36 h-36 rounded-full bg-gradient-to-br from-accent to-primary opacity-95 flex items-center justify-center p-4 shadow-lg">
                    <svg className="w-20 h-20 text-white drop-shadow-md" fill="none" viewBox="0 0 24 24" stroke="currentColor">
